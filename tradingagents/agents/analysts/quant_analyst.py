...
def create_quant_analyst(llm):
    def quant_analyst_node(state):
        ...
        system_message = (
            ...
            "   a risk is a CRITICAL ANALYTICAL ERROR."
            "\n"
            ...
            "\n| Implied FCF Growth (reverse DCF) | X% — MUST compute: g = WACC − (FCF / MarketCap). Use TTM FCF from Valuation Cross-Check. NEVER write N/A if FCF data is available. SHOW arithmetic. |"
            "\n| 6-Month Return | X% |"
            "\n| Price vs 200-SMA | +X% |"
