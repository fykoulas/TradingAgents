...
def create_quant_analyst(llm):
    def quant_analyst_node(state):
        ...
        system_message = (
            ...
            "\n   • If Gap is POSITIVE (Implied > Actual CAGR): the market expects MORE perpetual"
            "\n     growth than the company has historically delivered → potentially OVERPRICED."
            "\n     Example: Implied FCF Growth 8%, Revenue CAGR 3% → Gap +5pp → market expects"
            "\n     nearly 3x the company's structural growth rate in perpetuity."
            "\n   • If Gap is NEGATIVE (Implied < Actual CAGR): the market expects LESS growth"
            "\n     than the company has historically delivered → potentially UNDERPRICED."
            "\n     Example: Implied FCF Growth 4%, Revenue CAGR 10% → Gap −6pp → conservative."
            ...
            "\n| Growth Gap | +X.Xpp — GOLDEN VARIABLE: COPY from verified data 'Growth Gap'. OVERPRICED if positive, UNDERPRICED if negative, FAIRLY PRICED if ±3pp. |"
