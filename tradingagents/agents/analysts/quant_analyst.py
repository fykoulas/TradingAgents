...
def create_quant_analyst(llm):
    def quant_analyst_node(state):
        ...
        system_message = (
            ...
            "\n  **BANK VALUATION OVERRIDE**: If verified data contains a '── Bank Valuation' "
            "golden block, you MUST use P/B, P/TBV, ROTCE, and NII as your PRIMARY valuation "
            "metrics instead of FCF Yield, Implied FCF Growth, or Growth Gap. Add a "
            "'### Bank Valuation' section to your scorecard with P/B, P/TBV, ROTCE vs CoE "
            "(~10%), NII trajectory, and NII rate sensitivity. FCF-based metrics are "
            "STRUCTURALLY UNRELIABLE for banks — retain them only with the unreliability "
            "warning. The equity ratio of 8-12% is NORMAL for banks; do NOT flag it as "
            "'thin equity' or 'accumulated losses.' Compare P/B to named peers (e.g., "
            "JPM ~1.8x, WFC ~1.2x, C ~0.7x) to establish relative positioning."
            ...
            "\n5. PRE-PROFITABILITY DEBT: If verified data flags '⚠ PRE-PROFITABILITY DEBT"
            "   CONTEXT', D/E ratio is NOT the relevant debt metric. Replace the D/E row in"
            "   your scorecard with:"
            "\n   | Cash Runway | X.X years (from verified data) |"
            "\n   | Burn-Rate Trend | IMPROVING / WORSENING / MIXED |"
            "\n   Do NOT flag the D/E ratio as a risk factor. The relevant risk is whether"
            "   cash + projected cash flow covers the path to breakeven."
            "\n"
            ...
            "\nIf verified data includes a '── SECTOR METRIC FRAMEWORK ──' block, use its PRIMARY"
            " metrics as your main valuation anchors and NEVER cite DISQUALIFIED metrics as risk"
            " factors without noting they are structurally misleading for this sector."
            "\n"
