        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                (
                    ...
                    ' {{"technical_outlook": "BULLISH or BEARISH or NEUTRAL", "valuation_outlook": "UNDERVALUED or FAIRLY_VALUED or OVERVALUED", "confidence": "HIGH or MEDIUM or LOW", "data_gaps": []}}'
                    "\n{system_message}"
