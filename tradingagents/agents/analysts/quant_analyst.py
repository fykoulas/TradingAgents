...
def create_quant_analyst(llm):
    def quant_analyst_node(state):
        ...
        system_message = (
            ...
            "\n2. **Growth Gap**: Is the implied growth ACHIEVABLE? If the market prices in 30%"
            "   annual EPS growth but the company has grown EPS at 15% historically, the stock"
            "   is priced for perfection. Flag this."
            "\n3. **Reverse DCF**: At the current price, what FCF growth rate is implied?"
            "   Use your DCF model inputs in reverse: given Price = X, what growth g makes"
            ...
            "\n| Growth Gap (Implied − Actual) | +X% (overpriced / fairly priced / underpriced) |"
            "\n| Implied FCF Growth (from DCF) | X% |"
            "\n| 6-Month Return | X% |"
            "\n| Price vs 200-SMA | +X% |"
