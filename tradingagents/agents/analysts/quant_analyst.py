...
def create_quant_analyst(llm):
    def quant_analyst_node(state):
        ...
        system_message = (
            ...
            "\n   - This means either Implied FCF Growth or Revenue CAGR data is unavailable."
            "\n   - For the Growth Gap row, write: 'N/A — see verified data for reason.'"
            "\n   - If Implied FCF Growth is available but Revenue CAGR is not (or vice versa),"
            "\n     state the available metric and note the gap cannot be computed."
            "\n"
