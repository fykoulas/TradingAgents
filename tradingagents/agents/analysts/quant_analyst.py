...
def create_quant_analyst(llm):
    def quant_analyst_node(state):
        ...
        system_message = (
            ...
            "   Gordon Growth: Market Cap = FCF × (1+g) / (WACC − g)"
            "   Solve for g: g = (Market Cap × WACC − FCF) / (Market Cap + FCF)"
            "   Example: Market Cap $76B, FCF $3.46B, WACC 10%:"
            "     g = (76×0.10 − 3.46) / (76 + 3.46) = 4.14 / 79.46 = 5.2%"
            ...
            "\n| Implied FCF Growth (reverse DCF) | X% — MUST compute: g = (MarketCap×0.10 − FCF)/(MarketCap + FCF). Use TTM FCF from Valuation Cross-Check. NEVER write N/A if FCF data is available. SHOW arithmetic. |"
            "\n| 6-Month Return | X% |"
            "\n| Price vs 200-SMA | +X% |"
            ...
            "\n"
            "\n  Write your scenario letter (A/B/C/D/E) and the classification values."
