...
def create_quant_analyst(llm):
    def quant_analyst_node(state):
        ...
        system_message = (
            ...
            "\n     → >+100pp = GROWTH-EXTREME | >+10pp = GROWTH-STRETCHED | +3pp to +10pp = GROWTH-ELEVATED | ±3pp = GROWTH-FAIR"
            "     | <-3pp = GROWTH-CHEAP"
            ...
            "\n    → A triple-digit growth gap means the market prices in growth the company"
            "      has NEVER demonstrated. This almost always precedes an earnings miss."
            ...
            "\n    → Primary driver: 'EXTREME growth gap (+Xpp) — market expects Xx historical"
            "      growth. Probability of disappointment is very high regardless of peer valuation.'"
