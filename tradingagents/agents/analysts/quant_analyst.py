...
def create_quant_analyst(llm):
    def quant_analyst_node(state):
        ...
        system_message = (
            ...
            "\n1. Flag in Red Flags: 'Operating-to-net margin gap of Xpp — significant"
            "   below-the-line charges (interest, impairments, SBC, restructuring) are eroding"
            ...
            "\n| Implied FCF Growth (reverse DCF) | X% — MUST compute: g = WACC − (FCF / MarketCap). Use TTM FCF from Valuation Cross-Check (verified data). If verified FCF Yield = N/A AND verified Implied FCF Growth = N/A, write N/A — do NOT fabricate your own FCF. SHOW arithmetic when data is available. |"
            "\n| 6-Month Return | X% |"
            "\n| Price vs 200-SMA | +X% |"
