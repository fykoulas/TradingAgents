...
def create_fundamentals_analyst(llm):
    def fundamentals_analyst_node(state):
        ...
        system_message = (
            ...
            "\n  The Gordon Growth perpetuity model: Market Cap = FCF × (1+g) / (WACC − g)"
            "\n  Solving for g: g = (Market Cap × WACC − FCF) / (Market Cap + FCF)"
            "\n  Example: Market Cap $76B, FCF $3.46B, WACC 10%:"
            "\n    g = (76 × 0.10 − 3.46) / (76 + 3.46) = (7.6 − 3.46) / 79.46 = 4.14 / 79.46 = 5.2%"
            ...
            "\n| Check | Value |"
            "\n|-------|-------|"
            "\n| Market-Implied Growth (from reverse DCF — SHOW FORMULA) | X% |"
