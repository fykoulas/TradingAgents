...
def create_fundamentals_analyst(llm):
    def fundamentals_analyst_node(state):
        ...
        system_message = (
            ...
            "\n1. DECOMPOSE the gap into: interest expense, depreciation/amortisation above EBITDA,"
            "   impairments/write-downs, restructuring charges, stock-based compensation (SBC),"
            "   tax effects, and other non-operating items."
            "\n2. For each material component, state whether it is RECURRING (interest, SBC,"
            "   ongoing D&A) or NON-RECURRING (restructuring, impairment, litigation)."
